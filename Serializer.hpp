...
public:
    ...
    explicit Serializer(StreamBuffer dev, int byteorder = LittleEndian) {
...
public:
    ...
    ArgsTuple get_tuple(std::index_sequence<I...>) {
        ArgsTuple t;
        /* E op ... unexpanded to (E1 op ( E2 op ( ... op (EN-1 op EN)))
         *      */
        initializer_list<int>{((getv<ArgsTuple, I>(*this, t)), 0)...};
        return t;
    }
